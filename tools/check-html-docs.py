...
def main() -> int:
    ...
    required = [
        ...
        "abi.html",
        "testing.html",
        "man/pkgcatalog-scan.1.html",
        "man/pkgcatalog_acquire.3.html",
        "man/pkgcatalog_collection_layout.5.html",
        "protocols/collection-layout-v1.html",
        "history/catalog-2.1-extraction.html",
        "api/index.html",
        "assets/house.css",
